              ...
              <div class="card-header">
				...
				<div class="col-md-5 pl-1">
                   <div class="form-group">
                     <label>기간 검색</label>
            <input type="date" class="form-control" style="display: inline-block; width: auto; margin-right: 10px;" placeholder="yyyy/mm/dd">
            <input type="date" class="form-control" style="display: inline-block; width: auto;" placeholder="yyyy/mm/dd">
                   </div>
                 </div>
              </div>
              <div class="card-body">
...
<div class="card">
<div class="card-body">
<h5 class="header-title pb-3 mt-0">정산 내역</h5>
