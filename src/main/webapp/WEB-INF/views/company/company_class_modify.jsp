				...
				<form action="classModifyPro" name="classModifyForm" method="post" enctype="multipart/form-data">
					...
					<div class="tab-content">
							...
							<div class="card card-content5">
										...
										<div class="col-md-3 pr-1">
											<div class="form-group">
												...
												<select class="form-control" name="class_category">
													<option value="1" ${classDetail.class_category eq 1 ? 'selected' : ''}>
														정규모집
													</option>
													<option value="2" ${classDetail.class_category eq 2 ? 'selected' : ''}>
														원데이 클래스
													</option>
												</select>
											</div>
										...
										<div class="col-md-3 pr-1">
											<div class="form-group">
												...
												<select class="form-control" name="class_main_category" id="interior_type">
													...
													<option value="3" ${classDetail.class_category eq 3 ? 'selected' : ''}>
														부분 인테리어
													</option>
													<option value="4" ${classDetail.class_category eq 4 ? 'selected' : ''}>
														야외 시공
													</option>
													<option value="5" ${classDetail.class_category eq 5 ? 'selected' : ''}>
														종합 인테리어
													</option>
													<option value="6" ${classDetail.class_category eq 6 ? 'selected' : ''}>
														기타 시공
													</option>
									...
									<div class="row">
													...
													<tr>
														<td class="td2" align="left">
															...
															<c:if test="${not empty classDetail.class_pic2}">
																...
																test="${not empty classDetail.class_pic3}">
										...
										<div class="col-md-6 pl-1">
											<div class="form-group">
												...
												<br>
												<div class="col-sm-8">
													<input type="radio" name="addressOption" id="existingAddress" value="existing" checked>기존 공방 주소 출력하기
													<br>
													<div class="form-group">
								...
								<div class="col-md-12">
									<div class="d-flex justify-content-end">
										<!-- 다음 버튼 -->
										<button type="button" class="btn btn-default btn-col-md-4 custom-font-size" id="goTo2Tab">
											다음
										</button>
									</div>
								</div>
						...
						<div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">
							<div class="card card-content6">
								<div class="card-header">
									<h5 class="title">클래스 수정 - 스케줄 및 부가정보</h5>
								</div>
								<div class="card-body">
									<div class="form-group">
										<!-- 스케줄 정보를 표시할 테이블 -->
											<div class="exist_schedule">
												<b>[ 기존 일정 ]</b>
											</div>
										<table id="existingScheduleTable" class="table">
											...
											<tbody>
												<tr>
													...
													<td>
														${classDetail.class_start_date}~
														${classDetail.class_end_date}
													</td>
													<td>
													...
													<td>
														${classDetail.class_member_count}
													</td>
												</tr>
											</tbody>
										</table>
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
																...
																<div class="row">
																	<div class="col-md-12 pr-1 mb-3">
																		<div class="form-group">
																			...
																			<input type="checkbox" id="mon_checkbox" onclick="updateCheckboxValue(this);" name="class_day" value="1" ${classDetail.class_day.charAt(0) == '1' ? 'checked' : ''}> 
																			<label for="mon_checkbox" class="checkbox-label">월</label>
																			
																			<input type="checkbox" id="tue_checkbox" onclick="updateCheckboxValue(this);" name="class_day" value="2" ${classDetail.class_day.charAt(1) == '1' ? 'checked' : ''}> 
																			<label for="tue_checkbox" class="checkbox-label">화</label>
																			
																			<input type="checkbox" id="wed_checkbox" onclick="updateCheckboxValue(this);" name="class_day" value="3" ${classDetail.class_day.charAt(2) == '1' ? 'checked' : ''}> 
																			<label for="wed_checkbox" class="checkbox-label">수</label>
																			
																			<input type="checkbox" id="thr_checkbox" onclick="updateCheckboxValue(this);" name="class_day" value="4" ${classDetail.class_day.charAt(3) == '1' ? 'checked' : ''}> 
																			<label for="thr_checkbox" class="checkbox-label">목</label>
																			
																			<input type="checkbox" id="fri_checkbox" onclick="updateCheckboxValue(this);" name="class_day" value="5" ${classDetail.class_day.charAt(4) == '1' ? 'checked' : ''}> 
																			<label for="fri_checkbox" class="checkbox-label">금</label>
																			
																			<input type="checkbox" id="sat_checkbox" onclick="updateCheckboxValue(this);" name="class_day" value="6" ${classDetail.class_day.charAt(5) == '1' ? 'checked' : ''}> 
																			<label for="sat_checkbox" class="checkbox-label">토</label>
																			
																			<input type="checkbox" id="sun_checkbox" onclick="updateCheckboxValue(this);" name="class_day" value="0" ${classDetail.class_day.charAt(6) == '1' ? 'checked' : ''}> 
																		...
																		<span class="modal_title">날짜</span><br>
																			<div class="modal_date">
																				<div class="form-group">
																					...
																					&nbsp; ~ &nbsp;
																					<input type="date" id="endDate" name="class_end_date" value="${classDetail.class_end_date}"> 
																					<br>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="modal_select">
																				<select class="form-control"
																					name="class_member_count">
																					<option value="1"
																						${classDetail.class_member_count eq 1 ? 'selected' : ''}>1명</option>
																					<option value="2"
																						${classDetail.class_member_count eq 2 ? 'selected' : ''}>2명</option>
																					<option value="3"
																						${classDetail.class_member_count eq 3 ? 'selected' : ''}>3명</option>
																					<option value="4"
																						${classDetail.class_member_count eq 4 ? 'selected' : ''}>4명</option>
																					<option value="5"
																						${classDetail.class_member_count eq 5 ? 'selected' : ''}>5명</option>
																					<option value="6"
																						${classDetail.class_member_count eq 6 ? 'selected' : ''}>6명</option>
																					<option value="7"
																						${classDetail.class_member_count eq 7 ? 'selected' : ''}>7명</option>
																					<option value="8"
																						${classDetail.class_member_count eq 8 ? 'selected' : ''}>8명</option>
																					<option value="9"
																						${classDetail.class_member_count eq 9 ? 'selected' : ''}>9명</option>
																					<option value="10"
																						${classDetail.class_member_count eq 10 ? 'selected' : ''}>10명</option>
																				</select>
																			</div>
																		</div>
																	</div>
															...
															<div class="modal-footer">
												                <input type="hidden" id="selectedDays" name="selectedDays" value="${classDetail.class_day}">
											...
											<div class="row">
												...
												<div class="col-md-12 pl-1">
													...
													<div class="input-group-curri">
														<input type="file" id="curriculum_imageFile0" name="file4" accept=".jpg, .jpeg, .png" class="custom-file-input" onchange="updateImagePreview(0)"> 
												...
												<div class="col-md-12 pl-1">
													...
													<!-- 이미지 프리뷰 영역 -->
													<div id="curriculum_imagePreview1"
														class="curriculum-image-preview">
													...
													<div class="input-group-curri">
														<input type="file" id="curriculum_imageFile1" name="file5" accept=".jpg, .jpeg, .png" class="custom-file-input" onchange="updateImagePreview(1)"> 
														<input type="text" class="form-control" name="class_curriculum_detail2" placeholder="커리큘럼 2단계 상세내용을 입력해주세요" value="${classDetail.class_curriculum_detail2}">
													</div>
												</div>
												<div class="col-md-12 pl-1">
													<label>3단계) 상세 내용</label>
													<!-- 이미지 프리뷰 영역 -->
													<div id="curriculum_imagePreview2"
														class="curriculum-image-preview">
													...
													<div class="input-group-curri">
														<input type="file" id="curriculum_imageFile2" name="file6" accept=".jpg, .jpeg, .png" class="custom-file-input" onchange="updateImagePreview(2)"> 
														<input type="text" class="form-control" name="class_curriculum_detail3" placeholder="커리큘럼 3단계 상세내용을 입력해주세요" value="${classDetail.class_curriculum_detail3}">
													</div>
												</div>
												<br>
												<br>
												<div class="col-md-4 pl-1">
													...
													<div class="input-wrapper">
														<input type="text" class="form-control" placeholder="ex) 100,000" name="class_price" value="${classDetail.class_price}" oninput="formatPrice(this)">
								...
								<div class="d-flex justify-content-end">
									<!-- 이전 버튼 -->
									<button type="button" class="btn btn-default btn-col-md-4 mr-2 custom-font-size" id="goToHomeFromProfile">
										이전
									</button>
									<!-- 다음 버튼 -->
									<button type="button" class="btn btn-default btn-col-md-4 custom-font-size" id="goTo3Tab">
										다음
									</button>
								</div>
							</div>
						...
						<div class="tab-pane" id="contact" role="tabpanel"
							...
							<div class="card">
								<div class="card-header">
									<h5 class="title">클래스 수정 - 기타 제공사항</h5>
								</div>
								<div class="card-body">
									...
									<div class="card_small">
										<div class="row">
											<div class="col-md-10">
												...
												<div class="form-group">
													<input type="checkbox" name="class_offering" value="1" id="workshop" ${fn:substring(classDetail.class_offering, 0, 1) == '1' ? 'checked' : ''}>&nbsp;
														<label for="workshop" class="register3_text_label">
															공방 보유
														</label> 
													<input type="checkbox" name="class_offering" value="2" id="park" ${fn:substring(classDetail.class_offering, 1, 2) == '1' ? 'checked' : ''}>&nbsp;
														<label for="park" class="register3_text_label">
															주차 공간
														</label> 
													<input type="checkbox" name="class_offering" value="3" id="wifi" ${fn:substring(classDetail.class_offering, 2, 3) == '1' ? 'checked' : ''}>&nbsp;
														<label for="wifi" class="register3_text_label">
															와이파이
														</label>
													<input type="checkbox" name="class_offering" value="4" id="coffee" ${fn:substring(classDetail.class_offering, 3, 4) == '1' ? 'checked' : ''}>&nbsp;
														<label for="coffee" class="register3_text_label">
															커피 별도구매
														</label> 
													<input type="checkbox" name="class_offering" value="5" id="bus" ${fn:substring(classDetail.class_offering, 4, 5) == '1' ? 'checked' : ''}>&nbsp;
														<label for="bus" class="register3_text_label">
															대중교통 용이
														</label>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<input type="checkbox" name="class_offering" value="6" id="taxi" ${fn:substring(classDetail.class_offering, 5, 6) == '1' ? 'checked' : ''}>&nbsp;
													<label for="taxi" class="register3_text_label">택시/자가용 추천</label> 
													
													<input type="checkbox" name="class_offering" value="7" id="snack" ${fn:substring(classDetail.class_offering, 6, 7) == '1' ? 'checked' : ''}>&nbsp;
											...
											<div class="form-group">
												...
												<div class="form-group">
													<input type="text" class="form-control"
														name="class_caution" placeholder="내용을 입력해주세요"
														value="${classDetail.class_caution}">
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="keyword"
														name="class_tag" placeholder="검색에 사용되는 단어를 키워드로 등록해주세요"
														value="${classDetail.class_tag}">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-9 pr-7">
											<div class="form-group">
												...
												<!-- ========================================================================== -->
												<br> <span class="register3_text">질문 1</span>
												<div class="form-group">
													<input type="text" class="form-control"
														placeholder="자주하는 질문을 입력해주세요" name="class_question1"
														value="${classDetail.class_question1}">
												</div>
												<span class="register3_text">답변 1</span>
												<div class="form-group">
													<input type="text" class="form-control"
														placeholder="자주하는 질문의 답변을 입력해주세요" name="class_answer1"
														value="${classDetail.class_answer1}">
												</div>
												<br> <span class="register3_text">질문 2</span>
												<div class="form-group">
													<input type="text" class="form-control"
														placeholder="자주하는 질문을 입력해주세요" name="class_question2"
														value="${classDetail.class_question2}">
												</div>
												<span class="register3_text">답변 2</span>
												<div class="form-group">
													<input type="text" class="form-control"
														placeholder="자주하는 질문의 답변을 입력해주세요" name="class_answer2"
														value="${classDetail.class_answer2}">
												</div>
												<br> <span class="register3_text">질문 3</span>
												<div class="form-group">
													<input type="text" class="form-control"
														placeholder="자주하는 질문을 입력해주세요" name="class_question3"
														value="${classDetail.class_question3}">
												</div>
												<span class="register3_text">답변 3</span>
												<div class="form-group">
													<input type="text" class="form-control"
														placeholder="자주하는 질문의 답변을 입력해주세요" name="class_answer3"
														value="${classDetail.class_answer3}">
												</div>
											</div>
										</div>
									</div>
						...
						<div class="tab-pane" id="extra" role="tabpanel"
							...
							<div class="card">
								<div class="card-header">
									<h5 class="title">클래스 수정 - 검수 요청 및 약관 동의</h5>
								</div>
								<div class="card-body">
									<div class="row">
