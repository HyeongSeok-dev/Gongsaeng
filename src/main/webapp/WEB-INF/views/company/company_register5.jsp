				...
				<!--  본문 시작 -->
					<div class="tab-content p-4">
						<div class="col-md-11">
							<!-- 탭 링크 -->
							<ul
								class="nav nav-tabs nav-tabs-custom border-bottom-0 mt-3 nav-justified"
								role="tablist">
								<li class="nav-item" role="presentation"><a
									class="nav-link active" data-bs-toggle="tab"
									href="#profile-tab" role="tab" aria-selected="true">기본 정보</a></li>
								<li class="nav-item" role="presentation"><a
									class="nav-link" data-bs-toggle="tab" href="#class-tab"
									role="tab" aria-selected="false">스케줄 및 부가정보</a></li>
								<li class="nav-item" role="presentation"><a
									class="nav-link" data-bs-toggle="tab" href="#reviews-tab"
									role="tab" aria-selected="false">기타 제공사항</a></li>
								<li class="nav-item" role="presentation"><a
									class="nav-link" data-bs-toggle="tab" href="#reviews-tab"
									role="tab" aria-selected="false">검수 요청 및 약관 동의</a></li>
							</ul>
							<div class="card">
								<div class="card-header">
									<h5 class="title">클래스 등록</h5>
								</div>
								<form action="ClassRegisterPro" method="post" enctype="multipart/form-data">
									<div class="tab-content class"></div>
														...
														<table style="margin-top: 30px;">
															<tr>
																<td class="td2" align="left">
																	...
																	<div id="img_zone">
																		<div id="img_preview0">
																			<input type="image" id="imgup_sum"
																				onclick="send_0();" src="" width="150px"
																				height="150px"> <span id="sum_style">대표
																				이미지</span>
																			<!-- 삭제버튼 -->
																		...
																		<div id="img_preview2">
																			<input type="image" id="imgup_2" onclick="send_2();"
																				...
																				id="del_img2" class="chk_style"
																				onclick="del_img2();">x</span>
																		</div>
																	</div>
																</td>
															</tr>
									...
									<div id="class-tab" class="tab-pane fade" role="tabpanel">
										<div class="col-md-11">
											<div class="card">
												...
												<div class="card-body">
													<form action="company/class/register3" method="post"
														enctype="multipart/form-data">
														<input type="hidden" name="class_category"
															value="${gclass.class_category}"> <input
															type="hidden" name="class_main_category"
															value="${gclass.class_main_category}"> <input
															type="hidden" name="class_sub_category"
															value="${gclass.class_sub_category}"> <input
															type="hidden" name="class_title"
															value="${gclass.class_title}">
														...
														<input type="hidden" name="post_code"
															value="${gclass.post_code}"> <input type="hidden"
															name="address1" value="${gclass.address1}"> <input
															type="hidden" name="address2" value="${gclass.address2}">
														<input type="hidden" name="class_introduction"
															value="${gclass.class_introduction}">
														<%-- ============================================================================= --%>
														<input type="hidden" name="class_day"
															value="${gclass.class_day}"> <input type="hidden"
															name="class_start_date"
															value="${gclass.class_start_date}"> <input
															type="hidden" name="class_end_date"
															value="${gclass.class_end_date}"> <input
															type="hidden" name="class_start_time"
															value="${gclass.class_start_time}"> <input
															type="hidden" name="class_end_time"
															value="${gclass.class_end_time}"> <input
															type="hidden" name="class_member_count"
															value="${gclass.class_member_count}">
														<%-- 							    <input type="hidden" name="file4" value="${file4}"> --%>
														<%-- 							    <input type="hidden" name="file5" value="${file5}"> --%>
														<%-- 							    <input type="hidden" name="file6" value="${file6}"> --%>
														<input type="hidden" name="class_curriculum_detail1"
															value="${gclass.class_curriculum_detail1}"> <input
															type="hidden" name="class_curriculum_detail2"
															value="${gclass.class_curriculum_detail2}"> <input
															type="hidden" name="class_curriculum_detail3"
															value="${gclass.class_curriculum_detail3}"> <input
															type="hidden" name="class_price"
															value="${gclass.class_price}">
																				...
																				<div class="modal-content">
																					...
																					<div class="modal-body">
																							...
																							<div class="col-md-12 pr-1 mb-3">
																								<div class="form-group">
																									...
																									<div class="modal_check">
																										...
																										<label for="mon_checkbox"
																											class="checkbox-label">월</label> <input
																											type="hidden" name="class_day" value="1">

																										<input type="checkbox" id="tue_checkbox"
																											onclick="updateCheckboxValue(this);">
																										<label for="tue_checkbox"
																											class="checkbox-label">화</label> <input
																											type="hidden" name="class_day" value="2">

																										<input type="checkbox" id="wed_checkbox"
																											onclick="updateCheckboxValue(this);">
																										<label for="wed_checkbox"
																											class="checkbox-label">수</label> <input
																											type="hidden" name="class_day" value="3">

																										<input type="checkbox" id="thr_checkbox"
																											onclick="updateCheckboxValue(this);">
																										<label for="thr_checkbox"
																											class="checkbox-label">목</label> <input
																											type="hidden" name="class_day" value="4">

																										<input type="checkbox" id="fri_checkbox"
																											onclick="updateCheckboxValue(this);">
																										<label for="fri_checkbox"
																											class="checkbox-label">금</label> <input
																											type="hidden" name="class_day" value="5">

																										<input type="checkbox" id="sat_checkbox"
																											onclick="updateCheckboxValue(this);">
																										<label for="sat_checkbox"
																											class="checkbox-label">토</label> <input
																											type="hidden" name="class_day" value="6">

																										<input type="checkbox" id="sun_checkbox"
																											onclick="updateCheckboxValue(this);">
																										<label for="sun_checkbox"
																											class="checkbox-label">일</label> <input
																											type="hidden" name="class_day" value="0">
																										<br>
																									</div>
																									<p class="modal_day_instruction">하나 이상의
																										운영요일이 선택되어야 합니다.</p>
																								</div>
																							</div>
																						</div>
																						...
																						<div class="row">
																							<div class="col-md-8 pr-1 mb-3">
																								<div class="form-group">
																									<span class="modal_title">클래스 운영시간(한
																										타임당)</span><br>
																						...
																						<div class="row">
																							<div class="col-md-8 pr-1 mb-2">
																								<div class="form-group">
																									<span class="modal_title">클래스 최대 인원(한
																										타임당)</span>
														...
														<div class="col-md-12 pr-7">
															<div class="form-group">
																...
																<input type="file" id="sumimage" style="display: none;"
																	name="file4" accept=".jpg, .jpeg, .png"> <input
																	type="file" id="imageFile1" style="display: none;"
																	name="file5" accept=".jpg, .jpeg, .png"> <input
																	type="file" id="imageFile2" style="display: none;"
																	name="file6" accept=".jpg, .jpeg, .png">
																<!-- 											</form> -->
																<table style="margin-top: 30px;">
																	<tr>
																		<!-- 								<td class="td2" align="left"> -->
																		<td class="td2 curriculum-detail" align="left">
																			...
																			<div id="img_zone">
																				...
																				<div id="img_preview1">
																					<input type="image" id="imgup_1"
																						onclick="send_1();" src="" width="150px"
																						height="150px">
																					<!-- 삭제버튼 -->
																					<span id="del_img1" class="chk_style"
																						onclick="del_img1();">x</span>
																				...
																				<div id="img_preview2">
																					<input type="image" id="imgup_2"
																						onclick="send_2();" src="" width="150px"
																						height="150px"> <span id="del_img2"
																						class="chk_style" onclick="del_img2();">x</span>
																				</div>
																			</div>
																		</td>
																	</tr>
																...
																<div class="row">
																	...
																	<div class="col-md-4 pl-1">
																		...
																		<!-- Hidden 값들을 출력 -->
																		<p>Class Category:>>>>>>>>>>>>>>>
																			${gclass.class_category}</p>
																		<p>Class Main Category:
																			${gclass.class_main_category}</p>
																		<p>Class Sub Category:
																			${gclass.class_sub_category}</p>
																		<p>Class Title: ${gclass.class_title}</p>
																	</div>
																</div>
															</div>
														</div>
