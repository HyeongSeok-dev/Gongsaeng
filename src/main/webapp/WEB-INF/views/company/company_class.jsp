...
<a class="primary-link" href="#">인테리어 원데이 클래스</a><span class="badge bg-success ms-1"><i class="mdi mdi-star align-middle"></i>4.8</span>
</h5>
<p class="text-muted mb-2">원데이 | 소품만들기 </p>
<ul class="list-inline mb-0 text-muted">
<li class="list-inline-item"><i class="mdi mdi-map-marker"></i>서면 아이티윌</li>
<li class="list-inline-item"><i class="mdi mdi-wallet"></i> 50,000원 / 4시간</li>
</ul>
</div>
</div>
<div class="col-lg-4">
