									...
									<div class="row">
										<div class="col-md-7 pr-1">
											<div class="form-group">
												<label><b>- 기타 제공사항 선택</b></label><br> 
												<label class="checkbox-inline"><input type="checkbox" value="">공방 보유</label>
												<label class="checkbox-inline"><input type="checkbox" value="">주차공간</label>
												<label class="checkbox-inline"><input type="checkbox" value="">와이파이</label>
												<label class="checkbox-inline"><input type="checkbox" value="">커피 별도구매</label>
												<label class="checkbox-inline"><input type="checkbox" value="">대중교통 용이</label>
												<label class="checkbox-inline"><input type="checkbox" value="">택시/자가용 추천</label>
												<label class="checkbox-inline"><input type="checkbox" value="">음료/간식 제공</label>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-9 pr-7">
											<div class="form-group">
												<label><b>- 추가 제공사항 및 유의사항</b></label>
												<!-- ========================================================================== -->
												<br>
												<div class="form-group">
<!-- 													<label>시작일</label>  -->
			...
			<button type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/company/class/register4'">다음</button>
					</div>
					<div class="col-md-4">
