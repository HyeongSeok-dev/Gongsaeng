...
function toggleDropdownMenu(event) {
    ...
    if (notify_dropdownContent.style.display === 'none' || dropdownContent.style.display === '') {
    	notify_dropdownContent.style.display = 'block';
    } else {
    	notify_dropdownContent.style.display = 'none';
    }
}
        ...
        <div class="collapse navbar-collapse yamm" id="navigation">
            <div class="button navbar-right">
            	...
            	<a href="${pageContext.request.contextPath}/mypage/main">
					<button class="navbar-btn nav-button_not" data-wow-delay="0.45s"><b>admin</b>님</button>
				</a>
            	<%-- 회원페이지 area --%>
...
<!-- 					<button class="navbar-btn nav-button wow fadeInRight" data-wow-delay="0.48s">장바구니</button> -->
<!-- 				</a> -->
                <%-- 장바구니에 담은 상품이 있을 경우 --%>
				<a href="${pageContext.request.contextPath}/cart">
