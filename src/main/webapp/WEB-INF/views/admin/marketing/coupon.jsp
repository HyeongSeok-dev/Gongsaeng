				...
				<div class="row">
					<div class="col-md-4">
						<div class="card">
							...
							<div class="card-body">
								<form action="couponPro" method="post">
									<div class="row">
										<div class="col-md-12 pr-1">
											<div class="form-group">
												<label>쿠폰이름</label> <input type="text" class="form-control" name="coupon_name">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12 pr-1">
											<div class="form-group">
												<label>발행대상(공란일 경우 전체발행)</label> <input type="text" class="form-control" name="member_id">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6 pr-1">
											<div class="form-group">
												<label>유효시작일</label> <input type="date" class="form-control" name="coupon_Issue_date">
											</div>
										</div>
										<div class="col-md-6 pl-1">
											<div class="form-group">
												<label>유효종료일</label> <input type="date" class="form-control" name="coupon_valid_date">
											</div>
										</div>
									</div>
									<div class="row ">
										<div class="col-md-12">
											<div class="form-group">
												<label> 할인값 <select name="value_category" class="coupon_unit">
														<option value="원">원</option>
														<option value="%">%</option>
												</select>
												</label> <input type="text" name="coupon_value" class="form-control">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>사용조건</label> <input type="text" class="form-control" name="coupon_min_price">
											</div>
										</div>
									</div>
