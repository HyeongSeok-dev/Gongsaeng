        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
	               <div class="card-body-header filter">
	               		<div class="member_category_checkbox">
			              	<input type="checkbox" value="전체선택" name="member_category"> &nbsp;전체선택&nbsp;
			              	<input type="checkbox" value="정상" name="member_category"> &nbsp;정상&nbsp;
			              	<input type="checkbox" value="휴면" name="member_category"> &nbsp;휴면&nbsp;
			              	<input type="checkbox" value="탈퇴" name="member_category"> &nbsp;탈퇴&nbsp;
			              	<br>
			              	<input type="checkbox" value="전체선택" name="member_category"> &nbsp;전체선택&nbsp;
			              	<input type="checkbox" value="정상" name="member_category"> &nbsp;정상&nbsp;
			              	<input type="checkbox" value="휴면" name="member_category"> &nbsp;휴면&nbsp;
