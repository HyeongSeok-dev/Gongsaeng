...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/my_messages.css">
							...
							<li class="list-group-item cursor" data-toggle="collapse" href="#alert">알림/메시지
								<div id="alert" class="panel-collapse collapse in">
									<ul class="list-group">
										...
										<li class="list-group-item cursor active" onclick="javascript:location.href='messages'">메시지</li>
									</ul>
								</div>
							</li>
