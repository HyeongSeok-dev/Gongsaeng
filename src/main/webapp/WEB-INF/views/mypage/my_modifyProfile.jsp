						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="text-center">
									<c:choose>
										<c:when test="${empty member.member_img}">
											<img alt="profile" src="${pageContext.request.contextPath }/resources/img/default_user_img.png" style="cursor: pointer; max-height: 250px;" class="img-thumbnail">
										</c:when>
										<c:when test="${fn:contains(member.member_img,'http')}">
											<img alt="profile" src="${member.member_img}" style="cursor: pointer; max-height: 250px;" class="img-thumbnail">
										</c:when>
										<c:otherwise>
											<img alt="profile" src="${pageContext.request.contextPath }/resources/upload/${member.member_img}" style="cursor: pointer; max-height: 250px;" class="img-thumbnail">
										</c:otherwise>
									</c:choose>
