				...
				<div class="panel panel-default">
					...
					<div class="row">
						<c:if test="${empty couponList}">
							<div class="panel-body">쿠폰이 없습니다. 반장님을 팔로우해 쿠폰을 받으세요</div>
						</c:if>
									...
									<div class="panel-body pull-left">
										<div class="row ">
											<div class="col-xs-12 ">
												...
												<p>${coupon.coupon_min_price}원이상구매시사용 가능</p>
												...
												<p>${days}일남음(유효기간: ${coupon.coupon_Issue_date} ~ ${coupon.coupon_valid_date})</p>
												<c:choose>
