						...
						<ul class="list-group">
							...
							<li class="list-group-item cursor" data-toggle="collapse" href="#favorList">관심리스트
								<div id="favorList" class="panel-collapse collapse in">
									<ul class="list-group">
										<li class="list-group-item cursor active" onclick="javascript:location.href='bookmark'">북마크</li>
						...
						<div class="panel-body">
							<div class="row">
								<c:if test="${empty bookmarkList}">
									<div class="panel-body">북마크가 없습니다.</div>
								</c:if>
										...
										<div class="product-grid pull-left">
											<div class="product-image">
												...
												<ul class="product-links">
													<li><span class="material-symbols-outlined bookmarkBtn" style="cursor: pointer;"> heart_minus </span> <input type="hidden"
